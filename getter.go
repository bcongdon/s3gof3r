...
func newGetter(getURL url.URL, c *Config, b *Bucket, offset int64) (io.ReadCloser, http.Header, error) {
	g := new(getter)
	g.url = getURL
...
func (g *getter) initChunks(startAt int64) {
	id := 0
	for i := startAt; i < g.contentLen; {
